...
namespace WasaCommunity
{
    ...
    {
        //Values collected and saved from appsettings.json
        ...
        private const string KeyIssuer = "KeyIssuer";
        //Case values
        ...
        public static IIdentityServerBuilder AddSigninCredentialFromConfig(
            this IIdentityServerBuilder builder, IConfigurationSection options, ILoggerFactory loggerFactory)
        {
            ILogger logger = loggerFactory.CreateLogger("SignInCredentialExtensionLogger");
        ...
        {
            var keyIssuer = options.GetValue<string>(KeyIssuer);
